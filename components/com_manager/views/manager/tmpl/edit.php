...
?>
	...
	<table class="proddetaylsinfo" cellpadding="0" cellspacing="0" border=0>
		...
		<tbody>
			<tr>
				<td><?php if ($this->car->year > 1900) echo $this->car->year; else echo '-'; ?></td>
				<td><?php if ($this->car->EngineSize) echo $this->car->EngineSize; else echo '-'; ?></td>
				<td><?php if ($this->car->TipKPP) echo $this->car->TipKPP; else echo '-'; ?></td>
			</tr>
		</tbody>
	</table>
	<br />
	...
	<table class="proddetaylsinfo" cellpadding="0" cellspacing="0" border=0>
		...
		<tbody>
			<tr>
				<td><?php if ($this->car->Probeg) echo $this->car->Probeg; else echo '-'; ?></td>
				<td><?php if ($this->car->TipKuzova) echo $this->car->TipKuzova; else echo '-'; ?></td>
				<td><?php if ($this->car->TipTopliva) echo $this->car->TipTopliva; else echo '-'; ?></td>
			</tr>
		</tbody>
	</table>
	<br />
